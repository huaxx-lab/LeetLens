...
final class CodeRenderingContractTests: XCTestCase {
    ...
    func testAgentCardsAreCollapsedByDefaultAndSignatureCoversRuns() throws {
        ...
        XCTAssertTrue(conversation.contains("inline-bili-card"))
        XCTAssertTrue(conversation.contains("__applyBilibiliView"))
        XCTAssertTrue(conversation.contains("bilibiliView"))
        XCTAssertTrue(conversation.contains("cover-wrap"))
        XCTAssertTrue(conversation.contains("bili-byline"))
        XCTAssertTrue(conversation.contains("jump-latest-slot"))
        XCTAssertTrue(conversation.contains("right: var(--context-panel-inset)"))
        XCTAssertFalse(conversation.contains("left: calc((100vw"))
        XCTAssertTrue(conversation.contains("inline-solution-card"))
        XCTAssertTrue(conversation.contains("nearbyArticleTitle"))
        XCTAssertTrue(conversation.contains("parseArticleHeading"))
        XCTAssertTrue(conversation.contains("isReplaceableLink"))
        XCTAssertTrue(conversation.contains("SOLUTION_URL_PATTERN"))
        XCTAssertTrue(conversation.contains("__applyLeetCodeSolution"))
        XCTAssertTrue(conversation.contains("leetcodeSolution"))
        XCTAssertTrue(conversation.contains("articleSlug"))
