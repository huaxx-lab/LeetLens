...
// SwiftPM flattens processed resources; source-tree verification keeps the package layout.
let fsrsModule;
try { fsrsModule = require('./index.cjs'); }
catch { fsrsModule = require('./node_modules/ts-fsrs/dist/index.cjs'); }
const { createEmptyCard, fsrs, Rating } = fsrsModule;
